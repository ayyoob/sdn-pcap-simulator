...
//
//	private static String deviceName = "belkincamera";
//	private static String deviceMac = "b4:75:0e:ec:e5:a9";
...
//				+ File.separator + deviceName + File.separator+ "generated" + File.separator;
...
//			} else if (ofFlow.getDstIp().equals(DEFAULT_GATEWAY_IP)) {
//				IetfMudMatch ietfMudMatch = new IetfMudMatch();
...
//				ietfMudMatch.setLocalNetworks(localString);
//				match.setIetfMudMatch(ietfMudMatch);
//			} else if (ofFlow.getSrcIp().equals(DEFAULT_GATEWAY_IP)) {
//				IetfMudMatch ietfMudMatch = new IetfMudMatch();
//				ietfMudMatch.setController(DEFAULTGATEWAYCONTROLLER);
//				match.setIetfMudMatch(ietfMudMatch);
//			} else {
...
//				+ File.separator + deviceName + "Mud.json", "UTF-8");
//		out.write(mudSpec);
//		out.flush();
//		out.close();
//	}
