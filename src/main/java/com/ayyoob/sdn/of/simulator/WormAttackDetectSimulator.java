...
public class WormAttackDetectSimulator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ClassLoader classLoader = WormAttackDetectSimulator.class.getClassLoader();
        File file = new File(classLoader.getResource("apps/simulator_config.json").getFile());
        Object obj = parser.parse(new FileReader(file));

        JSONObject jsonObject = (JSONObject) obj;

        String pcapLocation = "/Users/ayyoobhamza/Desktop/unsw/6-machineoptimize/pcap/worm/";
