...
//            "00:16:6c:ab:6b:88,samsungsmartcamMud.json,samsungsmartcam\n"+
    ...
    public static void main(String[] args) throws Exception {
        ...
        ClassLoader classLoader = AllAttackSimulator.class.getClassLoader();
        File file = new File(classLoader.getResource("apps/simulator_config.json").getFile());
        Object obj = parser.parse(new FileReader(file));

        JSONObject jsonObject = (JSONObject) obj;

        String pcapLocation = "/Users/ayyoobhamza/Desktop/unsw/1-anomalydetection/dataset/pcap/testing/";
