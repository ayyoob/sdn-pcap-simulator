...
public class AllAttackSplitSimulator {

    private static String devicedetails =
//            "b4:75:0e:ec:e5:a9,belkincameraMud.json,belkincamera,b4750eece5a9SsdpRemoteL2D2L\n" +
            "b4:75:0e:ec:e5:a9,belkincameraMud.json,belkincamera,b4750eece5a9ArpSpoofL2D\n" +
                    "b4:75:0e:ec:e5:a9,belkincameraMud.json,belkincamera,b4750eece5a9PortVulnerabilityTest\n" +
                    "b4:75:0e:ec:e5:a9,belkincameraMud.json,belkincamera,b4750eece5a9SmurfDeviceL2D\n" +
                    "b4:75:0e:ec:e5:a9,belkincameraMud.json,belkincamera,b4750eece5a9SmurfLocalL2D2L\n" +
                    "b4:75:0e:ec:e5:a9,belkincameraMud.json,belkincamera,b4750eece5a9SmurfLocalL2D2W\n" +
                    "b4:75:0e:ec:e5:a9,belkincameraMud.json,belkincamera,b4750eece5a9SsdpRemoteL2D2W\n" +
                    "b4:75:0e:ec:e5:a9,belkincameraMud.json,belkincamera,b4750eece5a9SsdpRemoteW2D2W\n" +
                    "";
    ...
    public static void main(String[] args) throws Exception {
        ...
        ClassLoader classLoader = AllAttackSplitSimulator.class.getClassLoader();
        ...
        for (String dt : devicedetails.split("\n")) {
            ...
            String folderName = dt.split(",")[3].replace(".json", "");
            String newPcapLocation = pcapLocation + dt.split(",")[3] + ".pcap";
